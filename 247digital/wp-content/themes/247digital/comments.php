...
<?php if ( comments_open() ) : ?>
	...
	<?php  
	 $fields=array(
		'author' => '<div class="enigma_form_group"><label for="exampleInputEmail1">Nom<small>*</small></label><input name="author" id="name" type="text" id="exampleInputEmail1" class="enigma_con_input_control"></div>',
	...
	add_filter('comment_form_default_fields','my_fields');
		...
		'title_reply_to' => __( 'Répondre %s','weblizar'),
		'id_submit' => 'enigma_send_button',
		'label_submit'=>__( 'Laisser un commentaire','weblizar'),
		'comment_notes_before'=> '',
		'comment_notes_after'=>'',
		'title_reply'=> '<h2>'.__('COMMENTAIRE','weblizar').'</h2>',		
		'role_form'=> 'form',		
		);
