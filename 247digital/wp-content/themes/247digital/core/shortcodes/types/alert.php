		...
		<tbody>
			<tr><td class="lable-all">Alert Type</td>
    			<td><select class="select-medium" size="1" id="alert_style" name="alert_style">
					<option value="enigma_alert_success" selected="selected">Success</option>
					<option value="enigma_alert_error">Error</option>
					<option value="enigma_alert_warning">Warning</option>
					<option value="enigma_alert_info">Info</option>
					</select>
				</td>
    		</tr>				
			<tr><td class="lable-all">Title</td>
    			<td><input class="input-medium" placeholder="http://weblizar.com" type="text" id="alert_heading" value="" name="alert_heading"></td>
    		</tr>
