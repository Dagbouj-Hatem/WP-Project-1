...
<form action="/" method="get" accept-charset="utf-8">
    <table class="table table-bordered table-condensed" style="margin-left:35px;">
		<tbody>
			<tr>
    			<td class="lable-all">Style</td><td>&nbsp;</td>
    			<td>
					<select style="width:150px;" id="dropcp_style" name="dropcp_style">
						<option value="enigma_dropcape_square" selected="selected">Square Colored</option>
						<option value="enigma_dropcape_circle">Circle Colored</option>
						<option value="enigma_dropcape_simple">Simple</option>						
					</select>
				</td>
    		</tr>
			<tr>
				<td class="lable-all">First Letter </td><td>&nbsp;</td>
			...
			<tr>
				<td class="lable-all">Content</td><td>&nbsp;</td>
			...
			<tr><td>&nbsp;</td><td>&nbsp;</td>
				<td><a href="javascript:DropDialog.insert(DropDialog.local_ed)" id="insert" style="display: block; line-height: 24px;">Insert</a></td>
			</tr>
		</tbody>
	</table>
</form>