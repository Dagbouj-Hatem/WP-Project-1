<?php
// Template Name: Portfolio-2-Ver-Columns 
 get_header(); 
	...
	<div class="row enigma_portfolio_page enima_photo_gallery portfolio " id="isotope-portfolio-container">
		<?php
				...
				$args = array('post_type' => 'weblizar_portfolio', 'posts_per_page' =>$all_posts);
					...
					?>
					<div class="col-xs-12 col-sm-6 col-md-6 portfolio-item-wrapper <?php foreach ($terms_names as $term) {   $tax_term = str_replace(' ', '_', $term);  echo preg_replace('~[^A-Za-z\d\s-]+~u', 'wl', $tax_term). " "; } ?>"> 
						<div class="img-wrapper">
							<div class="enigma_home_portfolio_showcase">
								 <?php if(has_post_thumbnail()) {	
									$class=array('class'=>'enigma_img_responsive');
									the_post_thumbnail('portfo_v2_thumb',$class);
